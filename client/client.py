...
class CollaborativeEditor:
    def __init__(self):
        ...
        self.style.theme_use('clam')  # other alternatives like 'alt', 'default', 'classic'
    ...
    def on_key_press(self, event):
        if not self.connected:
            return 'break'  # if disconnected => prevent default behavior
    ...
    def get_cursor_index(self):
        try:
            ...
            if count:
                ...
                return 0  # handling the case of None or empty
    ...
    def receive_changes(self):
        while True:
            self.connection_event.wait()  # waiting until connected
            try:
